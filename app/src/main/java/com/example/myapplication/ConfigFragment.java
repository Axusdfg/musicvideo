...
import com.example.adapter.ConfigGridAdapter;
...
public class ConfigFragment extends Fragment {
    ...
    private void initView(View view) {
        this.activity_config_gv = (GridView) view.findViewById(R.id.config_gv);
        this.activity_config_btn_help = (Button) view.findViewById(R.id.btn_help);
        this.activity_config_btn_feedback = (Button) view.findViewById(R.id.btn_feedback);
        this.activity_config_btn_more = (Button) view.findViewById(R.id.btn_more);
        this.activity_config_btn_logout = (Button) view.findViewById(R.id.btn_logout);
